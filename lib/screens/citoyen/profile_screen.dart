...
import 'package:frontend_t_hero/screens/citoyen/mes_signalements_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  String _nom   = 'Amira Bouazizi';
  String _email = 'amira@test.com';
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (nomCtrl.text.isNotEmpty) {
                    ...
                    _showSnack('Profil mis à jour ✓', TColors.success);
                  }
                },
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pop(context);
                  _showSnack(
                    'Mot de passe mis à jour ✓', TColors.success);
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: TColors.primary,
                  foregroundColor: Colors.white,
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // ── FIXED: navigates to MesSignalementsScreen ──
                  _menuItem(
                    context,
                  ...
                  // ── FIXED: navigates to ParametresScreen ──────
                  _menuItem(
                    context,
