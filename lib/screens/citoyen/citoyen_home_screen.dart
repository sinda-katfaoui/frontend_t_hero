...
class _CitoyenHomeScreenState extends State<CitoyenHomeScreen>
  ...
  Future<void> _fetchSignalements() async {
    if (_userId.isEmpty) { setState(() => _loadingData = false); return; }
  ...
  String _prioEmoji(String p)   { switch (p) { case 'ELEVEE': return '🔴'; case 'MOYENNE': return '🟡'; default: return '🟢'; } }
  ...
  int get _enCours => _signalements.where((s) => s['statut'] == 'EN_COURS' || s['statut'] == 'EN_ATTENTE').length;
  ...
  Widget _timelineStep(String emoji, String title, String sub, bool done, {bool isLast = false}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(children: [
          ...
          if (!isLast)
            Container(width: 2, height: 28,
              color: done ? TColors.primary.withValues(alpha: 0.3) : TColors.borderLight),
        ]),
  ...
  Widget _divLine() => const Divider(height: 1, thickness: 0.5, color: TColors.borderLight);
    ...
    return Expanded(
      child: InkWell(
        onTap: () {
          ...
          if (index == 3) _notifKey.currentState?.refresh();
        },
        borderRadius: BorderRadius.circular(8),
        child: Padding(
          padding: const EdgeInsets.symmetric(vertical: 8),
            ...
            children: [
              FadeTransition(
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      colors: [TColors.primary, Color(0xFFE53935), Color(0xFFC62828)],
                      begin: Alignment.topLeft, end: Alignment.bottomRight),
                    ...
                    Padding(
                      ...
                      child: Column(children: [
                        Row(
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              GestureDetector(
                                onTap: () { setState(() => _currentIndex = 4); _fetchSignalements(); },
                                child: Container(
                                  width: 42, height: 42,
                                  decoration: BoxDecoration(
                        ...
                        Container(
                          ...
                          child: Row(children: [
                            _bannerStat('$_total',   'Signalements', Icons.flag_outlined),
                            _bannerDiv(),
                            _bannerStat('$_enCours', 'En cours',     Icons.pending_outlined),
                            _bannerDiv(),
              ...
              _loadingData
                ...
                : recent.isEmpty
                  ...
                  : Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16),
                      child: Column(children: recent.map((s) => _card(s, isDark)).toList())),
  ...
  Widget _catPill(String emoji, String label, bool isDark) {
    ...
    return Padding(
      ...
      child: Column(children: [
        Container(
          width: 80, height: 80,
          decoration: BoxDecoration(
            gradient: LinearGradient(colors: [TColors.primaryLight, TColors.primary.withValues(alpha: 0.1)]),
        ...
        const Text('Aucun signalement',
          style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700,
            color: TColors.textPrimary, fontFamily: 'Poppins')),
        const SizedBox(height: 6),
        const Text('Signalez un problème dans votre ville\net contribuez à l\'améliorer 🇹🇳',
          textAlign: TextAlign.center,
          style: TextStyle(fontSize: 13, color: TColors.textHint, fontFamily: 'Poppins', height: 1.5)),
        const SizedBox(height: 20),
        GestureDetector(
          onTap: () async {
            await Navigator.push(context, MaterialPageRoute(builder: (_) => const NewSignalementScreen()));
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(colors: [TColors.primary, Color(0xFFE53935)]),
              borderRadius: BorderRadius.circular(14)),
          ...
          child: Column(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16)),
              child: Row(children: [
                _bannerStat('$_total',   'Total',    Icons.flag_outlined),
                _bannerDiv(),
                _bannerStat('$_enCours', 'En cours', Icons.pending_outlined),
                _bannerDiv(),
                _bannerStat('$_resolus', 'Résolus',  Icons.check_circle_outline),
          ...
          child: Container(
            ...
            child: Row(
              children: List.generate(3, (i) {
                final labels = ['Tous', 'En cours', 'Résolus'];
                ...
                return Expanded(
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: sel ? (isDark ? TColors.cardDark : Colors.white) : Colors.transparent,
                        borderRadius: BorderRadius.circular(10),
                        border: sel ? Border.all(color: TColors.borderLight, width: 0.5) : null),
                      child: Text(labels[i],
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 13, fontFamily: 'Poppins',
                          fontWeight: sel ? FontWeight.w600 : FontWeight.w400,
                          color: sel ? TColors.primary : TColors.textHint)),
                    ),
                  ),
                );
              }),
